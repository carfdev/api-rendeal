...
import type { IEmail } from "@/services/interfaces/IEmail";

export class ForgotPassword {
  constructor(
    private readonly adminRepository: IAdmin, // Dependency for accessing admin data
    private readonly jwt: IJWT, // Dependency for handling JWT tokens
  ...
  async execute(email: string) {
    try {
      // Validate input
      if (!email) {
        return { error: "Email is required" }; // Return an error if the email is missing
      }

      // Retrieve the admin by email from the repository
      const admin = await this.adminRepository.getAdminByEmail(email); // Return an error if no admin is found with the given email
      if (!admin) {
...
<v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="${url}" style="height:46px;width:212px;v-text-anchor:middle;" arcsize="35%" stroke="false" fillcolor="#506bec">
<w:anchorlock/>
...
<![endif]--><a href="${url}" target="_blank" style="background-color:#506bec;border-bottom:0px solid TRANSPARENT;border-left:0px solid TRANSPARENT;border-radius:16px;border-right:0px solid TRANSPARENT;border-top:0px solid TRANSPARENT;color:#ffffff;display:inline-block;font-family:Helvetica Neue, Helvetica, Arial, sans-serif;font-size:15px;font-weight:undefined;mso-border-alt:none;padding-bottom:8px;padding-top:8px;text-align:center;text-decoration:none;width:auto;word-break:keep-all;"><span style="word-break: break-word; padding-left: 25px; padding-right: 20px; font-size: 15px; display: inline-block; letter-spacing: normal;"><span style="word-break: break-word;"><span style="word-break: break-word; line-height: 30px;" data-mce-style><strong>RESET MY PASSWORD</strong></span></span></span></a><!--[if mso]></center></v:textbox></v:roundrect><![endif]--></div>
														...
														<tr>
															<td class="pad">
																<div style="color:#40507a;font-family:Helvetica Neue, Helvetica, Arial, sans-serif;font-size:14px;line-height:120%;text-align:left;mso-line-height-alt:16.8px;">
																	<p style="margin: 0; word-break: break-word;"><span style="word-break: break-word;">Having trouble? <a href="http://www.example.com/" target="_blank" title="@socialaccount" style="text-decoration: none; color: #40507a;" rel="noopener"><strong>@socialaccount</strong></a></span></p>
																</div>
															</td>
														</tr>
													</table>
      ...
      const res = await this.email.sendForgotPassword(email, body);
      // Return the response
      return res;
    } catch (e) {
